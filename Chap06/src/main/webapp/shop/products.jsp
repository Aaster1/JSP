	...
	<div class="px-4 py-5 my-5 text-center">
		...
		<div class="col-lg-6 mx-auto">
			...
			<div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
				<button type="button" class="btn btn-primary btn-lg px-4 gap-3" onclick="location.href='./add.jsp'">상품 등록</button>
...
<!-- 				[NEW] 상세 정보 버튼 추가 -->
				<p>
					<a href="./product.jsp?id=<%= product.getProductId()%>" class="btn btn-primary">상세화면</a>
				</p>
			</div>
